            ...
            <div className="p-4 mt-28">
                <div className="sm:flex h-[600px]">
                    <div className='flex-none lg:pl-16 sm:pl-5 items-center h-80 py-9 lg:pr-4 sm:pr-0'>
                        <h2 className='mb-10 text-start border-b-4  inline-block text-3xl font-bold'>How does it <span className='text-primary'>work?</span></h2>
                        <AccordianSection
                    ...
                    <div className='bg-primary grow max-h-[500px] w-full relative rounded invisible md:visible' >
