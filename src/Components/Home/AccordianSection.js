            ...
            <div class="p-4 mt-28">
                <div class="flex h-screen">
                    <div className='flex-none pl-16 items-center h-80 py-9 w-[450px] pr-4'>
                        ...
                        <div tabindex="0" class="collapse border-base-300 bg-base-100 hover:border rounded hover:drop-shadow-xl mb-1">
                            <div class="collapse-title text-xl font-medium text-slate-400  hover:text-black ">
                                The teacher sets up an assignment
                            </div>
                            <div class="collapse-content w-96">
                        ...
                        <div tabindex="0" class="collapse border-base-300 bg-base-100 hover:border rounded hover:drop-shadow-xl">
                            <div class="collapse-title text-xl font-medium text-slate-400  hover:text-black ">
                    ...
                    <div className='bg-amber-400 grow h-[500px] w-full relative rounded'>
                        <img src={image} class=" absolute right-0 bottom-[55px] w-4/5 h-96 rounded-lg shadow-2xl" alt='education-pic' />
                    </div>
                </div>
            </div>
        </div>
