...
const Gallery = () => {
    return (
        <div className='mt-[100px]'>
            ...
            <section classNeme="overflow-hidden">
                <div classNeme="max-w-screen-xl px-5 py-20 mx-auto ">
                    <div classNeme="flex flex-wrap -m-1 md:-m-2">
                        <div classNeme="flex flex-wrap w-1/2">
                            <div classNeme="w-1/2 p-1 md:p-2">
                                <img alt="gallery" classNeme="block object-cover  object-center w-full h-full rounded-lg"
                            ...
                            <div classNeme="w-full p-1 md:p-2">
                                <img alt="gallery" classNeme="block object-cover object-center w-full h-full rounded-lg"
