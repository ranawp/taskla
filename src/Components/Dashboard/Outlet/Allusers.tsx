...
const Allusers = () => {
    ...
    return (
        <div>
            <h2 className='text-2xl text-center font-bold my-5 dark:text-slate-200'>All <span className='text-secondary'> users</span> </h2>

            <div className='flex justify-between'>
                < select className="select select-bordered mb-2 bg-gray-200 dark:bg-[#182233] text-primary dark:text-slate-200" >
                ...
                <div className='flex mr-2'>
                    <input
                        ...
                        className="input input-bordered border shadow-xl p-5 h-7 mb-3 size-30 dark:bg-[#182233] dark:text-slate-200 bg-transparent"
            ...
            <div className="overflow-x-auto" >
                ...
                <table className="text-left w-80 mx-auto sm:w-full dark:text-slate-50 border dark:border-[#293241]" >
...
{/* <h2 className='text-lg text-center font-bold my-5 dark:text-slate-50'>All users</h2>
            ...
            <div className="overflow-x-auto text-primary dark:text-slate-50" >
                <table className="table w-full border dark:border-[#293241]" >
                        ...
                        <tr className='bg-gray-200  dark:bg-[#182233]'></tr> */}