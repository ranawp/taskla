...
const Login = () => {
  ...
  return (
    <div className="sm:px-48 mt-32 register-page lg:flex justify-between items-center ">
      ...
      <div>
        <div className="w-80 p-10 mx-auto shadow-lg border dark:bg-[#182233]">
          <h1 className="text-center font-bold text-3xl my-4 text-primary dark:text-slate-200 ">Sign In</h1>
          <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
            <input
              className="my-2 p-2 rounded-lg bg-white dark:bg-[#182233] dark:text-slate-200 border inline"
              type="email"
            ...
            <div className="flex">
              <input
                className="my-2 p-2 rounded-lg bg-white dark:bg-[#182233] dark:text-slate-200 w-full inline border"
            ...
            <input
              className="my-2 py-2 rounded-lg text-white font-semibold cursor-pointer bg-secondary"
              value="Sign In"
              type="submit"
            />
            {errorElement}
